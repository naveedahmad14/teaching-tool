...
export default function QuickSortLesson() {
  ...
  return (
    <div className="w-full max-w-7xl mx-auto p-6 space-y-8">
      {/* Header */}
      <div className="bg-gradient-to-r from-purple-600 to-pink-600 rounded-xl p-4 sm:p-8 text-white shadow-xl">
      ...
      {/* Introduction */}
      <div className="bg-white rounded-xl shadow-lg p-4 sm:p-8">
        <h2 className="text-xl sm:text-3xl font-bold mb-3 sm:mb-4 text-gray-800">What is Quick Sort?</h2>
      ...
      <div className="bg-white rounded-xl shadow-lg p-4 sm:p-8">
        ...
        <div className="flex flex-wrap gap-3 sm:gap-4 mb-6">
          <button
            onClick={quickSort}
            disabled={sorting}
            className="w-full sm:w-auto px-6 py-3 bg-purple-600 text-white rounded-lg font-semibold hover:bg-purple-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors shadow-md"
          >
      ...
      {/* When to Use */}
      <div className="bg-white rounded-xl shadow-lg p-4 sm:p-8">
        <h2 className="text-xl sm:text-3xl font-bold mb-4 sm:mb-6 text-gray-800">When Should You Use Quick Sort?</h2>
