...
const slotBase = "px-3 py-2 text-xs font-bold uppercase tracking-wider border-2 transition-all duration-150 focus:outline-none focus:ring-2 focus:ring-[#FFD700] focus:ring-offset-2 focus:ring-offset-[#0F3460]";
const slotFont = { fontFamily: "'Press Start 2P', 'Courier New', monospace" };
...
export default function Navbar() {
  ...
  return (
    ...
    >
      {/* Gold accent line at top - quest UI flourish */}
      ...
      <div className="container mx-auto px-3 sm:px-4">
        <div className="flex flex-wrap items-center justify-between gap-2 py-2 sm:py-3">
          ...
          <div className="flex flex-wrap items-center gap-1.5 sm:gap-2">
            ...
            {status === "loading" ? (
              <span className={`${slotBase} border-[#625EC6]/50 bg-[#16213E] text-[#C0C0C0]`} style={slotFont} aria-live="polite">
                ...
              </span>
            ) : session ? (
              <>
                ...
                {/* User + logout - same slot style as nav links */}
                <span className="hidden sm:inline w-0.5 h-6 bg-[#625EC6] mx-0.5" aria-hidden />
                <div className="flex flex-wrap items-center gap-1.5 sm:gap-2 pl-1 sm:pl-2 border-l-2 border-[#625EC6] ml-1">
                  <span
                    className={`${slotBase} border-[#625EC6] bg-[#16213E] text-[#E8E8E8] max-w-[100px] sm:max-w-[120px] truncate normal-case`}
                    style={slotFont}
                  ...
                  <span
                    className={`${slotBase} border-[#FFD700] bg-[#16213E] text-[#FFD700] shrink-0`}
                    style={slotFont}
